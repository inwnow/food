...
while($row = sqlsrv_fetch_object($sql)){
    $obj->construct();
    $shows=$obj->getQuery(" foods "," where hn='$row->hn' and vn='$row->regist_flag' and ward_id='$wid' and dc='0'");
    $specials=$obj->getQuery(" specialfoods "," where hn='$row->hn' and vn='$row->regist_flag' and ward_id='$wid' and dc='0'");
if($shows->kind!=''){
	$n=$n+1;
	echo $shows->kind;
?>
...
<?php 
 $sp=$obj->getFetch(" select * from specialfoods  where hn='$row->hn' and vn='$row->regist_flag' and ward_id='$wid' and dc='0'");
$numsp=$obj->numrows(" specialfoods "," where hn='$row->hn' and vn='$row->regist_flag' and ward_id='$wid' and dc='0'");
...
<tr> 
	...
	<? 	$fdall=$obj->getAll("select count(distinct hn) as val from foods where ward_id='$wid' and (kind<>'' or kind is not null) and dc='0' "); echo $fdall->val;?> ราย
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd1=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='1' and dc='0' "); echo $fd1->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd2=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='2' and dc='0' "); echo $fd2->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd3=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='3' and dc='0' "); echo $fd3->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd4=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='4' and dc='0' "); echo $fd4->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd5=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='5' and dc='0' "); echo $fd5->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd6=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='6' and dc='0' "); echo $fd6->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd7=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='7' and dc='0' "); echo $fd7->val;?>
	</td>
    <td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd8=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='8' and dc='0' "); echo $fd8->val;?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:70px;">
	<? 	$fd9=$obj->getAll("select count(*) as val from foods where ward_id='$wid' and kind='9' and dc='0' "); echo $fd9->val;?>
	</td>
  </tr>
  </table>
...
<?
$sql=$obj->getFetch("select * from foods where ward_id='$wid' and category<>'' and dc='0' group by hn");
?>
...
<table style="border: 1px solid black;border-collapse:collapse;width:100%">
	...
	<th style="border: 1px solid black;font-family: THSarabun;font-size:12px;width:70px;" > <b>NPO</b></th>
	</tr>
...
<tr>
	...
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='2'){echo $rowsa->foodsize1." ซีซี x ".$rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='3'){echo $rowsa->foodsize1." ซีซี x ".$rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='7'){echo $rowsa->foodsize1." ซีซี x ".$rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='4'){echo $rowsa->foodsize1." ซีซี x ".$rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='5'){echo $rowsa->foodsize1." ซีซี x ".$rowsa->foodsize2;}
	?>
	</td>
	...
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='8'){echo $rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='9'){echo $rowsa->foodsize2;}
	?>
	</td>

	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='10'){echo $rowsa->foodsize2;}
	?>
	</td>
	<td style="border: 1px solid black;font-family: THSarabun;text-align: center;width:60px;font-size:12px">
	<?
		if($rowsa->category=='11'){echo $rowsa->foodsize2;}
	?>
	</td>
